...
public class GeneradorFibonacciTest {
    ...
    @Test
    public void testSumarFibonacci() {
    	int[] serie = fibo.generarFibonacci(5);
    	int resultado = fibo.sumarSerie(serie);
    	int esperado = 7;
        Assert.assertEquals(esperado, resultado);
    }
    
    @Test
    public void testSumarFibonacciZero() {
    	int[] serie = fibo.generarFibonacci(0);
    	int resultado = fibo.sumarSerie(serie);
    	int esperado = 0;
        Assert.assertEquals(esperado, resultado);
    }
    ...
    @Test
    public void testSumarFibonacciNegative() {
    	int[] serie = fibo.generarFibonacci(-3);
    	int resultado = fibo.sumarSerie(serie);
    	int esperado = 0;
        Assert.assertEquals(esperado, resultado);
    }
